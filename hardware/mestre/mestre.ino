...
char host[48];
String strhost = "192.168.43.41";
String strurl = "/";
String chipid = "";
IPAddress server(192,168,11,6); //Endereço IP do servidor - http_site
...
String enviardatos(String datos) {
  ...
  client.print(String("POST ") + strurl + " HTTP/1.1" + "\r\n" + 
               ...
               "\r\n" + "ab");           
  delay(10);             
  Serial.println("passou por aqui hahaha");
...
void setupMesh(){
  ...
  Serial.println("2");
  meshNode.setStaticIP(IPAddress(192, 168, 4, 40)); // Activate static IP mode to speed up connection times.
  Serial.println("3");
}
...
void mesh() {
  ...
  if (millis() - timeOfLastScan > 6000) { // Scan for networks with two second intervals when not already connected.  
